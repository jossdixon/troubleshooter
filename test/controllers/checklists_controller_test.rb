...
class ChecklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post checklists_url, params: { checklist: { resolved_at: @checklist.resolved_at, template_id: @checklist.template_id } }
    end
  ...
  test "should update checklist" do
    patch checklist_url(@checklist), params: { checklist: { resolved_at: @checklist.resolved_at, template_id: @checklist.template_id } }
